      ...
      <article className={styles.footerContent}>
        ...
        <aside className={styles.logoSection}>
          <h2 className={styles.logo}>
            the <span className={styles.logoItalic}>Curtain</span> shop
          </h2>
        ...
        <nav className={styles.linkColumn} aria-label="Product categories">
          ...
          <ul>
            <li><a href="#">Curtains & shades</a></li>
        ...
        <nav className={styles.linkColumn} aria-label="Additional links">
          ...
          <ul>
            <li><a href="#">FAQs</a></li>
            <li><a href="#">Curtain Information</a></li>
            <li><a href="#">Curtain Sizing</a></li>
            <li><a href="#">Shipping and Return Policies</a></li>
